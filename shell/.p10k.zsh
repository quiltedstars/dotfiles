# Generated by Powerlevel10k configuration wizard on 2021-12-09 at 13:57 AST.
...
() {
  ...
  # Custom icon.
   typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='%Bvoid'
  ...
  #stypeset -g POWERLEVEL9K_PROMPT_CHAR_LEFT_{LEFT,RIGHT}_WHITESPACE=

  ##################################[ dir: current directory ]##################################
  # Current directory background color.
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=6
  typeset -g POWERLEVEL9K_DIR_PATH_SEPARATOR='  '
  typeset -g POWERLEVEL9K_DIR_PATH_SEPARATOR_FOREGROUND=1
  ...
  typeset -g POWERLEVEL9K_DIR_HOME_FOREGROUND='#d0d0d0'
